            ...
            {projects.slice(0, 2).map((project, idx) => (
              <Link href={`/projects/${project.slug}`} key={project.id} className="block w-full h-full">
                <motion.div
                  ...
                  className="group relative flex flex-col justify-between p-8 md:p-10 bg-white/5 dark:bg-white/[0.03] backdrop-blur-[24px] saturate-[1.2] shadow-[inset_0_0_12px_rgba(255,255,255,0.2),_0_10px_30px_rgba(0,0,0,0.1)] dark:shadow-[inset_0_0_12px_rgba(255,255,255,0.08),_0_10px_30px_rgba(0,0,0,0.4)] border border-white/20 md:border-[1.5px] md:border-white/40 dark:border-white/10 md:dark:border-white/20 rounded-[2rem] hover:scale-[1.02] transition-transform duration-300 overflow-hidden min-h-[320px] h-full"
                >
                  {/* Natural Corner Highlights */}
                  <div className="absolute -inset-[1px] md:-inset-[1.5px] pointer-events-none rounded-[2rem] border border-white/60 md:border-[2px] md:border-white/90 dark:border-white/30 md:dark:border-white/60 mix-blend-overlay shadow-[inset_0_0_12px_rgba(255,255,255,0.3)] md:shadow-[inset_0_0_24px_rgba(255,255,255,0.5)] dark:shadow-[inset_0_0_12px_rgba(255,255,255,0.1)] md:dark:shadow-[inset_0_0_24px_rgba(255,255,255,0.2)] z-0" style={{ WebkitMaskImage: 'radial-gradient(ellipse 400px 150px at 50% 0%, black 0%, transparent 100%), radial-gradient(ellipse 150px 150px at 100% 100%, black 0%, transparent 100%)', maskImage: 'radial-gradient(ellipse 400px 150px at 50% 0%, black 0%, transparent 100%), radial-gradient(ellipse 150px 150px at 100% 100%, black 0%, transparent 100%)' }}></div>
